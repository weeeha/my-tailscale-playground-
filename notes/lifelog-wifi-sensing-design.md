...
> `scripts/fleet-capability-probe.sh` (already in this branch) tells you which of
> your nodes can do CSI vs. RSSI-only, and where cameras/GPIO live. **Run it first**
> — it decides which node plays which role above.
