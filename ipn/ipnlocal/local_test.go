...
func TestPeerWireGuardStateWatchInitialThenDeltas(t *testing.T) {
	...
	b.handlePeerWireGuardState(peer1.Key, ipn.PeerWireGuardStateEstablished)
	b.handlePeerWireGuardState(peer1.Key, ipn.PeerWireGuardStateEstablished)
	defer b.handlePeerWireGuardState(peer1.Key, ipn.PeerWireGuardStateNone)
	defer b.handlePeerWireGuardState(peer2.Key, ipn.PeerWireGuardStateNone)
...
func TestPeerWireGuardStateMetrics(t *testing.T) {
	...
	defer b.handlePeerWireGuardState(peer.Key, ipn.PeerWireGuardStateNone)
	...
	b.handlePeerWireGuardState(peer.Key, ipn.PeerWireGuardStateEstablished)
	...
	b.handlePeerWireGuardState(peer.Key, ipn.PeerWireGuardStateHandshake)
	...
	b.handlePeerWireGuardState(peer.Key, ipn.PeerWireGuardStateExpired)
	...
	b.handlePeerWireGuardState(peer.Key, ipn.PeerWireGuardStateNone)
